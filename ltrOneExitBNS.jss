...
;	This exit routine permits specific customization of the ltrOne JAWS script, thus 
...
;2025-05-16 v3.7.1 added Logging mode to Admin INI and code for writing out ltrOne-yymmdd.log
